...
export default function HelpPage({ user, onLogout, currentPage = "Help", onSidebarClick }) {
    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-teal-100 to-teal-50 flex">
      ...
      <div className="w-64 bg-teal-500 text-white p-4 flex flex-col justify-between">
        ...
        <div>
          <button
            onClick={onLogout}
            className="w-full bg-white text-black hover:bg-red-600 px-4 py-2 rounded border mt-4"
          >
            Logout
          </button>
        </div>
      ...
      <div className="flex-1 p-6">
        ...
        <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-gray-700">Help</h2>
